...
uint8_t read_status(LCD_Handle *pDisplay){
	...
	/*
	read |= HAL_GPIO_ReadPin(pDisplay->DB0.Port, pDisplay->DB0.Pin) << 0;
	read |= HAL_GPIO_ReadPin(pDisplay->DB1.Port, pDisplay->DB1.Pin) << 1;
	read |= HAL_GPIO_ReadPin(pDisplay->DB2.Port, pDisplay->DB2.Pin) << 2;
	read |= HAL_GPIO_ReadPin(pDisplay->DB3.Port, pDisplay->DB3.Pin) << 3;
	read |= HAL_GPIO_ReadPin(pDisplay->DB4.Port, pDisplay->DB4.Pin) << 4;
	read |= HAL_GPIO_ReadPin(pDisplay->DB5.Port, pDisplay->DB5.Pin) << 5;
	read |= HAL_GPIO_ReadPin(pDisplay->DB6.Port, pDisplay->DB6.Pin) << 6;
	read |= HAL_GPIO_ReadPin(pDisplay->DB7.Port, pDisplay->DB7.Pin) << 7;
	*/
...
{
	send_cmd(pDisplay, GPIO_PIN_RESET, GPIO_PIN_RESET, LCD_SET_PAGE_ADRESS + ((uint8_t)(y/8)));
	send_cmd(pDisplay, GPIO_PIN_RESET, GPIO_PIN_RESET, LCD_SET_COLUMN_ADDRESS + x);
